                     ...
                     <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                           <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                              <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Add Supplier</p>
                              <form name="formSuppliers" id="formSuppliers" action="saveSupplier.php" method="post" class="mx-1 mx-md-4 needs-validation" novalidate>
                              ...
                              If(isset($_GET['status']) && $_GET['status'] == 1){ ?>
                                   ...
                                   <p class="alert alert-success" role="alert">Supplier Added Successfully!</p>
                                </div>
                                </div>
                                <?php }
                             ...
                             <?php } ?>
                              <div class="d-flex flex-row align-items-center mb-4">
                                 ...
                                 <div class="d-flex flex-row align-items-center mb-4">
                                    ...
                                    <div class="form-outline flex-fill mb-0">
                                       <input type="text" id="phoneNo" name="phoneNo" class="form-control" onfocusout="formatPhone(this)" required/>
                                       <div class="valid-feedback">
                                       Valid
                                       </div>
                                       <div class="invalid-feedback">Invalid Input!</div>
