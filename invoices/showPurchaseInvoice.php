   ...
   <head>
      ...
      <script>
         ...
         if (invoiceId == "") {
            ...
            xmlhttp.open("GET","../models/getPurchaseItems.php?invoiceId="+invoiceId,true);
            xmlhttp.send();
         }
      });
               ...
               <div class="col-lg-12 col-xl-11">
                  <div class="container mt-3">
                     <div class="card" style="border-radius: 25px;">
                        <div class="card-body">
                           <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">View Purchase Invoices <i class="fa-solid fa-cart-shopping mx-1"></i></p>
                           <div class="container">
                                    ...
                                    <table class="table table-hover table-sortable" id="invoiceList">
                                       ...
                                       <tbody>
                                          ...
                                          <?php require '../config/dbConnection.php';
                                             $sql = "SELECT purchase_invoice_details.invoice_id, supplier_id, invoice_date, invoice_amount, payment_type 
                                             FROM purchase_invoice_details, purchase_invoice_payment_details 
                                             WHERE purchase_invoice_details.invoice_id =purchase_invoice_payment_details.invoice_id;";
      ...
      <div class="modal-dialog modal-fullscreen">
         <div class="modal-content">
            ...
            <div class="modal-header">
               <h4 class="modal-title">Show Purchase Details</h4>
