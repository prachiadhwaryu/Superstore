...
<html>
   <head>
      <title>View Suppliers | Superstore
      </title>
      <meta charset="UTF-8">
   ...
   <?php
         ...
         try {
            $query= "SELECT supplier_id, first_name, last_name, phone_no FROM supplier_master";
               ...
               <div class="col-lg-12 col-xl-11">
                  <div class="container mt-3">
                     <div class="card" style="border-radius: 25px;">
                        <div class="card-body">
                           <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">View Suppliers <i class="fa-solid fa-user mx-1"></i></p>
                           <div class="container">
                                       ...
                                       <tbody>
                                          ...
                                          <tr id='addr0' data-id="0" class="hidden">
                                             ...
                                             <td data-name="del" class="text-center">
                                                <a href=<?php echo '"../controllers/editSupplier.php?sid='.$row["supplier_id"].'"';?>><button name="del0" class='btn btn-info'><span aria-hidden="true">Edit</span></button></a>
                                             </td>
                                          </tr>
                                           <?php  endwhile; ?>
                                       </tbody>
